...
def easy():
    ...
    same_positions = 0
    while True:
        number_of_guess = int(input("Tell us how many attempts you would like to have: "))
        if 0 >= number_of_guess or number_of_guess > 20:
            print("Your attempts need to be between 1 and 20")
            continue
        else:
            break
    tries = 0
...
def hard():
    ...
    while True:
        ...
        if 4 > number_of_digits or number_of_digits > 10:
            print("You can select between 4 and 10 digits.")
            continue
        else:
            break
